...
def detect_duplicate(
    ...
    Returns (is_duplicate: bool, parent_complaint_id: int | None, confidence: int).
    """
    ...
    system_prompt = (
        ...
        f"{cand_summary}\n"
        "Respond ONLY with strict JSON: {\"is_duplicate\": true|false, \"matched_complaint_id\": <int or null>, \"reasoning\": \"one sentence\", \"confidence\": <int 0-100>}"
    )
    ...
    try:
        ...
        return is_dup, matched_id if is_dup else None, confidence
    ...
    return True, parent_complaint["id"], 80
